...
# Download a fresh copy from a known good source or recreate it
# Since git isn't working due to ownership issues, let's recreate the file
...
print("✅ Restored api_service.py to original working state")
