...
function computeIsAgentFromUser(u) {
  ...
  const flags = {
    ...
    rolesArrAgent:
      arrayHasAgent(rolesArr),

    groupsAgent:
      arrayHasAgent(groups),
...
async function computeIsAgentDeep(
  currentUser
) {
  const a1 =
    computeIsAgentFromUser(
      currentUser
    );
...
export default function SideMenu({
  ...
  /*
   * القائمة مثبتة على يمين الشاشة.
   *
   * translateX = 0
   * => القائمة ظاهرة.
   *
   * translateX = SHEET_W
   * => القائمة خارج الشاشة من جهة اليمين.
   */
          ...
          >
            ...
            >
              ...
              >
                ...
                <Pressable
                  accessibilityLabel="تلغرام"
                  onPress={() =>
                    safeOpenURL(
                      "https://t.me/starkcard"
                    )
                  }
                  style={({
                    pressed,
