...
class AgentProfile(models.Model):
    ...
    total_earnings_usd = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
    total_earnings_syp = models.DecimalField(max_digits=12, decimal_places=2, default=0.00)
    region = models.CharField(max_length=255, blank=True, null=True) 
    coverage_limit_usd = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=0.00,
        help_text="Maximum negative balance allowed for agent USD wallet"
    )
    coverage_limit_syp = models.DecimalField(
        max_digits=12,
        decimal_places=2,
        default=0.00,
