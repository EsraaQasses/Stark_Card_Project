# users/services/role_service.py
...
class RoleService:
    ...
    def promote_to_agent(user, promoted_by=None):
        ...
        wallet_usd, _ = Wallet.objects.get_or_create(user=user, currency="USD")
        wallet_syp, _ = Wallet.objects.get_or_create(user=user, currency="SYP")
